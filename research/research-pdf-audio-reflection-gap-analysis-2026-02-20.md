...
- 대조 대상
  ...
  - 구현 계획: `docs/implementation-plans/*`
...
- `docs/architecture-semantic-layer.md:1`
- `docs/architecture-semantic-layer.md:8`
- `docs/legacy-data-isolation-policy.md:1`
- `docs/legacy-data-isolation-policy.md:7`
...
- `docs/implementation-plans/synapse/98_gate-pass-criteria.md:5`
...
- `docs/implementation-plans/synapse/98_gate-pass-criteria.md:10`
...
- `docs/implementation-plans/core/98_gate-pass-criteria.md:11`
...
- `docs/implementation-plans/weaver/01_architecture-implementation-plan.md:26`
...
- `docs/implementation-plans/program/09_agent-governance-and-acceptance.md`는 운영 RACI 중심.
...
- 산출물:
  - `docs/domain-contract-registry.md` (신규)
