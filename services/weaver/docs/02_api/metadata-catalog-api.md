...
| **비즈니스 용어 사전** |  |  |  |  |  |
| `POST` | `/api/v1/metadata/glossary` | 용어 생성 | `metadata:write` | Implemented | `docs/implementation-plans/weaver/82_sprint3-ticket-board.md` |
| `GET` | `/api/v1/metadata/glossary` | 용어 목록 조회 | `metadata:read` | Implemented | `docs/implementation-plans/weaver/82_sprint3-ticket-board.md` |
| `GET` | `/api/v1/metadata/glossary/{term_id}` | 용어 상세 조회 | `metadata:read` | Implemented | `docs/implementation-plans/weaver/82_sprint3-ticket-board.md` |
| `PUT` | `/api/v1/metadata/glossary/{term_id}` | 용어 수정 | `metadata:write` | Implemented | `docs/implementation-plans/weaver/82_sprint3-ticket-board.md` |
| `DELETE` | `/api/v1/metadata/glossary/{term_id}` | 용어 삭제 | `metadata:write` | Implemented | `docs/implementation-plans/weaver/82_sprint3-ticket-board.md` |
| `GET` | `/api/v1/metadata/glossary/search` | 용어 검색 | `metadata:read` | Implemented | `docs/implementation-plans/weaver/82_sprint3-ticket-board.md` |
| **테이블/컬럼 태깅** |  |  |  |  |  |
