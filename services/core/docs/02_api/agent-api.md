...
|--------|------|------|---------|------|------------------|
| POST | `/api/v1/agents/chat` | 에이전트 채팅 메시지 전송 | 120s | Partial | `app/modules/agent/api/routes.py` |
| POST | `/api/v1/agents/feedback` | 사용자 피드백 제출 | 60s | Partial | `app/modules/agent/api/routes.py` |
| GET | `/api/v1/agents/feedback/{workitem_id}` | 피드백 상태 조회 | 10s | Partial | `app/modules/agent/api/routes.py` |
| POST | `/api/v1/completion/complete` | LLM 완성 (범용) | 120s | Partial | `app/modules/agent/api/routes.py` |
| POST | `/api/v1/completion/vision-complete` | 비전 모델 완성 | 120s | Partial | `app/modules/agent/api/routes.py` |
| POST | `/api/v1/mcp/config` | MCP 서버 설정 | 30s | Partial | `app/modules/agent/api/routes.py` |
| GET | `/api/v1/mcp/tools` | 사용 가능한 MCP 도구 목록 | 10s | Partial | `app/modules/agent/api/routes.py` |
| POST | `/api/v1/mcp/execute-tool` | MCP 도구 실행 | 60s | Partial | `app/modules/agent/api/routes.py` |
| GET | `/api/v1/agents/knowledge` | 학습된 지식 조회 (Memory/DMN/Skill) | 10s | Partial | `app/modules/agent/api/routes.py` |
| DELETE | `/api/v1/agents/knowledge/{id}` | 학습된 지식 삭제 | 10s | Partial | `app/modules/agent/api/routes.py` |
