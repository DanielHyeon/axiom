...
const statusConfig: Record<Case['status'], { label: string; className: string }> = {
 PENDING: { label: '대기', className: 'border border-amber-400/30 bg-warning/20 text-amber-300' },
 IN_PROGRESS: { label: '진행 중', className: 'border border-blue-400/30 bg-primary/20 text-primary/80' },
 COMPLETED: { label: '완료', className: 'border border-emerald-400/30 bg-success/20 text-emerald-300' },
 REJECTED: { label: '반려', className: 'border border-red-400/30 bg-destructive/20 text-red-300' },
};
