...
export function QueryHistoryPanel({ datasourceId, onSelect }: QueryHistoryPanelProps) {
 ...
 <p className="text-xs text-foreground/60 font-[IBM_Plex_Mono]">이력을 불러올 수 없습니다.</p>
 </div>
 );
 }
 ...
 return (
 <div className="py-8 text-center">
 <p className="text-xs text-foreground/60 font-[IBM_Plex_Mono]">최근 질의가 없습니다.</p>
 </div>
 );
 }
 ...
 <span className="mt-1.5 flex items-center gap-2 text-[11px] text-foreground/60 font-[IBM_Plex_Mono]">
 {item.created_at && (
