...
const TAB_CONFIG: { key: IngestionTab; label: string; icon: React.ElementType }[] = [
  { key: 'upload', label: t('dataIngestionPage.msg6c03f009'), icon: Upload },
  { key: 'pipelines', label: t('olapStudio.etl.title'), icon: Zap },
  { key: 'history', label: t('dataIngestionPage.msg690e7b16'), icon: History },
];
              ...
              <div className="p-4 bg-blue-50/60 rounded-xl border border-blue-100 space-y-3">
                ...
                <ol className="space-y-2 text-[11px] text-blue-800/80 leading-relaxed">
                  <li className="flex gap-2">
                    ...
                    <span>{t('dataIngestionPage.msgec2c2be5')}</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="shrink-0 flex items-center justify-center w-5 h-5 bg-blue-200 text-blue-800 rounded text-[10px] font-bold">
                      2
                    </span>
                    <span>{t('dataIngestionPage.whenDatasourceSelected')}</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="shrink-0 flex items-center justify-center w-5 h-5 bg-blue-200 text-blue-800 rounded text-[10px] font-bold">
                      3
                    </span>
                    <span>{t('dataIngestionPage.msg6c9c29eb')}</span>
                  </li>
                </ol>
              </div>
            </div>
