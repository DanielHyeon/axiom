...
export function ParameterSlider({ config, value, onChange, disabled }: ParameterSliderProps) {
 ...
 <label className="text-sm font-medium text-foreground/80">{config.name}</label>
 <span className="text-sm font-semibold text-primary bg-indigo-950/50 px-2 py-0.5 rounded">
 {value}{config.unit}
 </span>
 </div>
 <Slider
