...
- 설계 근거
  - `docs/01_architecture/self-verification.md:1`
  - `docs/01_architecture/self-verification.md:7`
  - `docs/01_architecture/self-verification.md:23`
- 코드 근거
...
- 설계 근거
  - `docs/01_architecture/4source-ingestion.md:1`
  - `docs/01_architecture/4source-ingestion.md:48`
  - `docs/01_architecture/4source-ingestion.md:49`
- 코드 근거
...
- 설계 근거
  - `docs/02_api/service-endpoints-ssot.md:21`
  - `docs/02_api/service-endpoints-ssot.md:25`
  - `docs/02_api/service-endpoints-ssot.md:48`
- 코드/배포 근거
  ...
  - SSOT 동기화 및 매핑 검증 강화: `docs/02_api/service-endpoints-ssot.md:1`, `tools/validate_ssot.py:1`
...
- 설계 근거
  - `docs/06_governance/legacy-data-isolation-policy.md:10`
- 코드 근거
...
3. SSOT-배포 파일 동기화
- 범위: `docs/02_api/service-endpoints-ssot.md`와 `docker-compose.yml`, `k8s/*.yaml` 단일 기준 정렬
