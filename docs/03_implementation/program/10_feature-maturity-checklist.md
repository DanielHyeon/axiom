...
- 계획: `docs/03_implementation/program/06_sprint5-execution-tickets.md`
...
- 계획: `docs/03_implementation/program/04_sprint3-execution-tickets.md`, `docs/03_implementation/synapse/98_gate-pass-criteria.md`
...
- 계획: `docs/03_implementation/program/06_sprint5-execution-tickets.md` (Phase 4 이관 명시)

### 5.5 Watch Agent
- 설계: `services/core/docs/01_architecture/event-driven.md`, `services/core/docs/02_api/watch-api.md`
- 계획: `docs/03_implementation/core/02_api-implementation-plan.md`, `docs/03_implementation/core/98_gate-pass-criteria.md`

### 5.6 이벤트 감지(CEP)
- 설계: `services/core/docs/99_decisions/ADR-004-redis-streams-event-bus.md`, `services/core/docs/01_architecture/event-driven.md`
- 계획: `docs/03_implementation/program/03_sprint2-execution-tickets.md`
