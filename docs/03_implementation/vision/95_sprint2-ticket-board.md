...
| VIS-S2-005 | Sprint2 결과 문서화 및 V1 사전점검 | docs/03_implementation/vision/98_gate-pass-criteria.md | VIS-S2-003,VIS-S2-004 | 0.5d | code-reviewer, code-documenter | V1 선행 항목 통과 |
