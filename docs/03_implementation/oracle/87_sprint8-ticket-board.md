...
| ORACLE-S8-005 | Sprint8 리뷰 및 문서 상태 동기화 | docs/03_implementation/oracle/98_gate-pass-criteria.md | ORACLE-S8-001,ORACLE-S8-004 | 0.5d | code-reviewer, code-documenter | 상태 태그/근거 컬럼 최신화 |
