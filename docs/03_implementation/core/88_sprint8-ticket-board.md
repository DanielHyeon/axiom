...
| CORE-S8-005 | Sprint8 리뷰 및 API 문서 상태 동기화 | docs/03_implementation/core/98_gate-pass-criteria.md | CORE-S8-001,CORE-S8-004 | 0.5d | code-reviewer, code-documenter | 상태 태그/근거 컬럼 최신화 |
