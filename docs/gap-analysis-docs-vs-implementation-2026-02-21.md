...
- 문서 근거
  - `docs/implementation-plans/program/10_feature-maturity-checklist.md:28`
  - `docs/implementation-plans/program/10_feature-maturity-checklist.md:29`
  - `docs/implementation-plans/program/10_feature-maturity-checklist.md:65`
  - `docs/implementation-plans/program/10_feature-maturity-checklist.md:66`
...
- 문서 근거
  - SSOT 포트: `docs/service-endpoints-ssot.md:20`~`docs/service-endpoints-ssot.md:25`
  - Docker/K8s 포함 공식 아키텍처: `docs/service-endpoints-ssot.md:47`~`docs/service-endpoints-ssot.md:56`
- 실제 코드
  ...
  - Vision 포트 불일치(SSOT 8400 vs compose 8000): `docs/service-endpoints-ssot.md:24` vs `docker-compose.yml:21`
...
- 문서 근거
  - Gate S1 요구: extraction/event-log/process-mining/schema-edit API 계약 100%: `docs/implementation-plans/synapse/98_gate-pass-criteria.md:9`
...
- 문서 근거
  - Sprint 7 Exit 체크 완료: `docs/implementation-plans/program/08_sprint7-execution-tickets.md:18`~`docs/implementation-plans/program/08_sprint7-execution-tickets.md:23`
  - D3 증적 규칙: Gate 증적 + 운영 지표 캡처 + 회귀 테스트: `docs/implementation-plans/program/10_feature-maturity-checklist.md:75`~`docs/implementation-plans/program/10_feature-maturity-checklist.md:78`
- 실제 코드
  - 일부 테스트는 스모크/스텁 중심
...
- 문서상 상태
  - `S7-PGM-005`, `S7-PGM-006` 완료로 표기: `docs/implementation-plans/program/08_sprint7-execution-tickets.md:13`, `docs/implementation-plans/program/08_sprint7-execution-tickets.md:14`
- 실제 판정
...
- 문서상 기준
  - Watch/Agent/Gateway 권한 누락 엔드포인트 0건: `docs/implementation-plans/core/98_gate-pass-criteria.md:11`
- 실제 판정
...
- 문서상 기준
  - extraction/event-log/schema-edit 포함 계약 100%: `docs/implementation-plans/synapse/98_gate-pass-criteria.md:9`
- 실제 판정
  - 해당 API 그룹 대부분 미구현
...
- Program/Feature 성숙도: `docs/implementation-plans/program/10_feature-maturity-checklist.md`
- Sprint 7 보드: `docs/implementation-plans/program/08_sprint7-execution-tickets.md`
- SSOT: `docs/service-endpoints-ssot.md`
