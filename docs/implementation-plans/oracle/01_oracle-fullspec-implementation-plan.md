...
> **근거**: [docs/implementation-plans/oracle/](.) (구현 계획), **코드 검증**: `services/oracle/app/`, `apps/canvas/src/features/nl2sql/` 실제 구현 대조  
...
- **docs/service-endpoints-ssot.md**: Oracle 포트·Base URL·Canvas VITE_ORACLE_URL 명시됨.
...
- **docs/implementation-plans/oracle/README.md**에 본 문서(01_oracle-fullspec-implementation-plan.md) 링크를 추가한다.
