...
| ORA-S2-006 | Sprint2 결과 문서화 및 O1 사전점검 | docs/implementation-plans/oracle/98_gate-pass-criteria.md | ORA-S2-004,ORA-S2-005 | 0.5d | code-reviewer, code-documenter | O1 체크 통과 |
