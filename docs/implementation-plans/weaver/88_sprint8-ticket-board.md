...
| WEAVER-S8-005 | Sprint8 리뷰 및 문서 상태 동기화 | docs/implementation-plans/weaver/98_gate-pass-criteria.md | WEAVER-S8-001,WEAVER-S8-004 | 0.5d | code-reviewer, code-documenter | 상태 태그/근거 컬럼 최신화 |
