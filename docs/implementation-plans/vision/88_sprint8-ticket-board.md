...
| VISION-S8-004 | Sprint8 리뷰 및 문서 상태 동기화 | docs/implementation-plans/vision/98_gate-pass-criteria.md | VISION-S8-001,VISION-S8-003 | 0.5d | code-reviewer, code-documenter | 상태 태그/근거 컬럼 최신화 |
