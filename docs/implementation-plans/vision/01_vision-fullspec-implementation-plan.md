...
> **근거**: [docs/future-implementation-backlog.md](../../future-implementation-backlog.md) §3, [docs/implementation-plans/vision/](.) (00~99 구현 계획), services/vision/docs 및 **코드 검증 결과**  
...
- Vision의 **미구현**, **스텁**, **Mock** 또는 **설계 문서 대비 갭**인 항목을 services/vision/docs 및 docs/implementation-plans/vision에 맞춰 Full 스펙으로 구현하기 위한 계획.
...
| **docs/service-endpoints-ssot.md** | Core→Vision 경로, Synapse 연동 |
