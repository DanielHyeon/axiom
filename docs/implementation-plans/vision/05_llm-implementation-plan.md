# VISION 05_llm LLM/에이전트 구현 계획

## 1. 문서 목적
- vision 프로젝트의 05_llm 설계 문서를 실제 구현 백로그로 변환한다.
- 단계별 책임 에이전트와 통과 기준을 명확히 정의한다.

## 2. 참조 설계 문서
- services/vision/docs/05_llm/causal-explanation.md
- services/vision/docs/05_llm/nl-to-pivot.md
