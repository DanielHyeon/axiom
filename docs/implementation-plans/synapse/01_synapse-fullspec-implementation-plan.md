...
> **근거**: [docs/future-implementation-backlog.md](../../future-implementation-backlog.md) §3, [docs/implementation-plans/synapse/](.) (00~99 구현 계획), services/synapse/docs 및 **코드 검증 결과**  
...
- Synapse의 **미구현**, **스텁**, **인메모리 한계** 또는 **설계 문서 대비 갭**인 항목을 services/synapse/docs 및 docs/implementation-plans/synapse에 맞춰 Full 스펙으로 구현하기 위한 계획.
...
| **docs/service-endpoints-ssot.md** §2.1 | Core→Synapse 경로 (process-mining/discover 등) |
...
- **docs/service-endpoints-ssot.md** 변경 시 Synapse 경로·버전 반영.
