...
| SYNAPSE-S8-006 | Sprint8 리뷰 및 문서 상태 동기화 | docs/implementation-plans/synapse/98_gate-pass-criteria.md | SYNAPSE-S8-001,SYNAPSE-S8-005 | 0.5d | code-reviewer, code-documenter | 상태 태그/근거 컬럼 최신화 |
