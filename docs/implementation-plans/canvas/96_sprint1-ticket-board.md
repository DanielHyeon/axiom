...
| CAN-S1-005 | E2E 핵심 여정 정의(대시보드-문서-NL2SQL) | apps/canvas/docs/04_frontend/case-dashboard.md | CAN-S1-003 | 1d | code-inspector-tester | E2E 시나리오 문서 완료 |
| CAN-S1-006 | 문서/추적 매트릭스 동기화 | docs/implementation-plans/canvas/* | CAN-S1-004,CAN-S1-005 | 0.5d | code-documenter | 추적 누락 0건 |
