...
## 범위
- 목표: Vision 분석 엔진(OLAP/What-if/Root Cause) 안정화
...
| S5-PGM-002 | Vision | analytics/olap/root-cause/what-if API 완성 | S5-PGM-001 | 5d | backend-developer, api-developer | Vision Gate V1 통과 |
...
| S5-PGM-005 | Program | Sprint 5 Exit Review | S5-PGM-002~004 | 1d | code-reviewer, code-security-auditor | Sprint6 진입 승인 |
