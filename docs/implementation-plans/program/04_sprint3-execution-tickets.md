...
|---|---|---|---|---|---|---|
| S3-PGM-001 | Program | Sprint 3 킥오프 및 계약 고정 재확인 | S2-PGM-009 | 0.5d | code-implementation-planner | 범위/의존 승인 |
...
| S3-PGM-006 | Synapse | FM-002 완료: 4-Layer 온톨로지 Gate 잔여항목 종료 | S3-PGM-002 | 1d | backend-developer, code-reviewer | FM-002 D3 완료 |
| S3-PGM-007 | Synapse | FM-003 완료: 비정형->온톨로지 HITL/커밋 흐름 검증 종료 | S3-PGM-002,S3-PGM-006 | 1d | backend-developer, code-inspector-tester | FM-003 D3 완료 |
| S3-PGM-008 | Program | Sprint 3 Exit Review | S3-PGM-002~007 | 1d | code-reviewer, code-security-auditor | Sprint4 진입 승인 |

## Sprint 3 Exit Criteria
- Synapse/Weaver 계약 테스트 100%
- 그래프/메타데이터 정합성 Critical 이슈 0건
- FM-002/FM-003 상태가 `D3 구현 완료`로 갱신됨
