...
> **근거 문서**: [docs/core-docs-vs-implementation-gap.md](../../core-docs-vs-implementation-gap.md)  
> **작성일**: 2026-02-22
...
| 문서 | 용도 |
|------|------|
| docs/core-docs-vs-implementation-gap.md | 갭 분석 원본 |
...
| ID | 제목 | 설명 | 산출 |
|----|------|------|------|
| B1 | 사용자·케이스 책임 결정 | Core 내 구현 vs 외부 Gateway/IdP 정책 확정. 결정 결과를 docs/settings-users-api-status.md 및 본 계획에 반영. | 결정 문서/ADR |
...
- docs/settings-users-api-status.md, admin-dashboard.md (API 경로).
...
| F5 | core-docs-vs-implementation-gap.md 갱신 | 해소된 갭은 “해소 완료”로 표시, 잔여 갭과 다음 단계 권장 조치만 유지. | docs/core-docs-vs-implementation-gap.md |
...
| 계획 문서 | 연계 Phase |
|----------|------------|
| docs/implementation-plans/core/07_security-implementation-plan.md | A, B |
| docs/implementation-plans/core/02_api-implementation-plan.md | A, B, C, F |
| docs/implementation-plans/core/03_backend-implementation-plan.md | D, E |
| docs/implementation-plans/core/01_architecture-implementation-plan.md | D, F |
| docs/core-docs-vs-implementation-gap.md | F (갱신) |
