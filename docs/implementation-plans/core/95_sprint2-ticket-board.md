...
| CORE-S2-006 | Sprint2 결과 문서 및 Gate C1/C2 사전점검 | docs/implementation-plans/core/98_gate-pass-criteria.md | CORE-S2-004,CORE-S2-005 | 0.5d | code-reviewer, code-documenter | C1/C2 체크 통과 |
