...
export const WhatIfBuilder: React.FC = () => {
 ...
 <div className="mb-4">
 <label className="block text-foreground font-bold mb-2">Target Metric Modifier</label>
 <input
 type="text"
 placeholder="E.g., +15% Logistics Cost"
 className="w-full border border-border rounded p-2 focus:ring-2 focus:ring-ring"
 value={modifier}
 ...
 {simulation && (
 <div className="mt-8 p-4 bg-background border rounded shadow-inner">
 <h3 className="font-bold text-foreground mb-2">Execution Results:</h3>
