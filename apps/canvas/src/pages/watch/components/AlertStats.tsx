export function AlertStats() {
 ...
 <div className="text-muted-foreground text-sm font-medium mb-1">총 알림 건수</div>
 ...
 <div className="text-destructive text-sm font-medium mb-1">처리 지연 (Critical)</div>
 <div className="text-2xl font-bold text-destructive">28</div>
 <div className="text-xs text-destructive/70 mt-2">즉시 조치 필요</div>
 </div>
 <div className="bg-popover border border-amber-900/50 rounded-lg p-5">
 <div className="text-warning text-sm font-medium mb-1">경고 (Warning)</div>
 <div className="text-2xl font-bold text-warning">142</div>
 <div className="text-xs text-warning/70 mt-2">모니터링 요망</div>
 </div>
 <div className="bg-popover border border-blue-900/50 rounded-lg p-5">
 <div className="text-primary text-sm font-medium mb-1">정보 (Info)</div>
 <div className="text-2xl font-bold text-primary">1,034</div>
 <div className="text-xs text-primary/70 mt-2">정상 운영중</div>
 </div>
 </div>
 );
}
