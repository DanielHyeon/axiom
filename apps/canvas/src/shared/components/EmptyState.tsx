...
export function EmptyState({ icon: Icon, title, description, actionLabel, onAction }: EmptyStateProps) {
 ...
 <div className="flex items-center justify-center w-12 h-12 mb-4 rounded-full bg-[#F5F5F5] border border-[#E5E5E5] text-foreground/60">
 <Icon size={24} />
 </div>
 <h3 className="mb-2 text-lg font-semibold text-black font-[Sora]">{title}</h3>
 <p className="max-w-sm mb-6 text-sm text-foreground/60 font-[IBM_Plex_Mono]">
 {description}
 </p>
